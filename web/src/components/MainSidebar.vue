  ...
  <div class="sidebar d-flex flex-column flex-shrink-0 bg-light">
    <nav class="d-flex flex-column h-100">
      ...
      <ul class="nav nav-pills nav-flush flex-column flex-grow-1 mb-auto text-center">
        <li v-if="isStudent" class="sidebar__link">
          <RouterLink :class="{active: $route.name === routes.student.name}" class="nav-link py-2" to="/student/marks">
        ...
        <li v-if="sessionStore.user" class="d-flex mt-auto align-items-center justify-content-center py-4 cursor-pointer">
